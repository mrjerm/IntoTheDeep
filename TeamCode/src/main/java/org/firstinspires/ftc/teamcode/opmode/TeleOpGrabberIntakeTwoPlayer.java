...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "TeleOp Two Player")
public class TeleOpGrabberIntakeTwoPlayer extends OpMode {
    ...
    private boolean touchpad2Prev = false;
...
//        elevatorRight.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    ...
    public void loop() {
        controlSpeed();
        drive();
        setMode(gamepad2.touchpad && !touchpad2Prev);
        switch (robotState){
            case SAMPLE:
                ...
                controlOuttakeSample(gamepad2.dpad_up, gamepad2.dpad_down, gamepad1.touchpad && !touchpadPrev, gamepad2.left_trigger > 0.1, gamepad2.right_trigger > 0.1, gamepad1.a);
                break;
            case SPECIMEN:
                ...
                controlOuttakeSpecimen(gamepad2.dpad_up, gamepad2.dpad_down, gamepad2.x, gamepad2.b, gamepad2.left_trigger > 0.1, gamepad2.right_trigger > 0.1, gamepad2.a);
...
//                }
    ...
    private void updateDebounce(){
        ...
        touchpad2Prev = gamepad2.touchpad;
    }
