...
import static org.firstinspires.ftc.teamcode.opmode.auto.AutoConstants.redSample_parkPose2;
...
@Autonomous(name = "Autonomous Red Sample TOGGLE PARK 1+2+0")
public class AutoRedSampleParkToggle extends OpMode {
...
//    private Path scorePreload, park;
    ...
    public void buildPaths(){
        ...
        park = follower.pathBuilder()
                .addPath(new BezierLine(new Point((redSample_scorePose)), new Point((parking ? redSample_parkPose1 : redSample_parkPose2))))
                .setLinearHeadingInterpolation(redSample_scorePose.getHeading(), (parking ? redSample_parkPose1 : redSample_parkPose2).getHeading(), 0.3)
                .build();
    }
...
//                        setPathState(6);
            ...
            case 8:
                ...
                if (Math.abs(follower.getPose().getX() - (parking ? redSample_parkPose1 : redSample_parkPose2).getX()) < positionThreshold && Math.abs(follower.getPose().getY() - (parking ? redSample_parkPose1 : redSample_parkPose2).getY()) < positionThreshold){
