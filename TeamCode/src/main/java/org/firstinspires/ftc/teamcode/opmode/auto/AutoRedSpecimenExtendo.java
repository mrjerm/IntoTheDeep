...
@Disabled
@Autonomous
public class AutoRedSpecimenExtendo extends OpMode {
...
//                .addPath(new BezierLine(new Point(redSpecimen_spikeRightPose), new Point(redSpecimen_spikeMiddlePose)))
//                .setLinearHeadingInterpolation(redSpecimen_spikeRightPose.getHeading(), redSpecimen_spikeMiddlePose.getHeading())
//                .addPath(new BezierLine(new Point(redSpecimen_spikeMiddlePose), new Point(redSpecimen_wallSpecimenPose)))
//                .setLinearHeadingInterpolation(redSpecimen_spikeMiddlePose.getHeading(), redSpecimen_wallSpecimenPose.getHeading())
                .addPath(new BezierLine(new Point(redSpecimen_spikeMiddlePose), new Point(redSpecimen_wallSpecimenPose)))
                .setLinearHeadingInterpolation(redSpecimen_spikeMiddlePose.getHeading(), redSpecimen_wallSpecimenPose.getHeading())
                .build();
